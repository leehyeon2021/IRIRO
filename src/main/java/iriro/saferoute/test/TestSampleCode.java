...
public class TestSampleCode {
    ...
    public static final List<RiskPointDto> dangerRoutePoints = List.of(
            ...
            new RiskPointDto("로", new BigDecimal("37.390335859209024"), new BigDecimal("126.95599747917913"), 1),
            new RiskPointDto("길", new BigDecimal("37.389222039983025"), new BigDecimal("126.95265892511556"), 3),
            new RiskPointDto("대로", new BigDecimal("37.38860541319803"), new BigDecimal("126.95088410379881"), 1),

            // ===== bbox로 걸러져야 할 먼 위험점 =====
            new RiskPointDto("길", new BigDecimal("37.4005000"), new BigDecimal("126.9705000"), 1),
            new RiskPointDto("로", new BigDecimal("37.4050000"), new BigDecimal("126.9650000"), 2),
            new RiskPointDto("대로", new BigDecimal("37.3820000"), new BigDecimal("126.9800000"), 1),
            new RiskPointDto("길", new BigDecimal("37.4100000"), new BigDecimal("126.9400000"), 4),
            new RiskPointDto("로", new BigDecimal("37.3700000"), new BigDecimal("126.9300000"), 1)
    );
